			...
			<div class="row">
						...
						<div class="col-sm-2">
							<input type="submit" class="btn btn-primary btn-md"
								...
								value="<%=BankListCtl.OP_SEARCH%>">&emsp;
				...
				<table class="table table-dark table-bordered">
					...
					<tbody>
						<tr>
							...
							<td align="center"><%=dto.getAccountNo() %></td> 
							<td align="center"><a href="BankCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
...
<div class="row">
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=BankListCtl.OP_BACK%>">
			</div>
			<%
				}
			%>
