...
<style type="text/css">
.reg {
	background-image: linear-gradient(to bottom right, orange, green, white);
}
</style>
</head>
<body>
...
<%--   				 <li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.BANK_CTL%>"><i
							class="fas fa-user-circle"></i>Add bank</a> <a class="dropdown-item"
							href="<%=ORSView.BANK_LIST_CTL%>"><i
							class="fas fa-university"></i>bank List</a>
					</div></li>
 --%>					
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.PAYMENT_CTL%>"><i
							class="fas fa-user-circle"></i>Add Payment</a> <a class="dropdown-item"
							href="<%=ORSView.PAYMENT_LIST_CTL%>"><i
							class="fas fa-user-circle"></i>Payment List</a>
					</div></li>
