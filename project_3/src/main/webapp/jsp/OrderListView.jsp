	...
	<div>
		<form class="pb-5" action="<%=ORSView.ORDER_LIST_CTL%>" method="post">
			...
			<%
				...
				List ulist = (List) request.getAttribute("sName");
			%>
			...
			<div class="row">
				...
				&emsp;
				<div class="col-sm-2">
					<input type="text" name="orderTyp" placeholder="Enter order type"
						class="form-control"
				...
				<div class="col-sm-2"><%=HTMLUtility.getList("Role", String.valueOf(dto.getRoleId()), list1)%></div> --%>
				  ...
				  &emsp;
				<div class="col-sm-2"><%=HTMLUtility.getList("sName", String.valueOf(dto.getsName()), ulist)%></div>
				&emsp;
				<%-- 	
				<div class="col-sm-2">
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="10%" class="text">Opretion</th>
					...
					<tbody>
						<tr>
							...
							<td> <a href="OrderCtl?id=<%=dto.getId()%>">Edit</a></td>
